    ...
    <>
      <div className="box">
        ...
        <h2>Transfer Money</h2>
          ...
          {
          <input type="Text" id='amt' className='amount' placeholder='Enter Account Holder Name' required />
          /* <div class="dropdown">
          ...
          <input type="text" id='amt' className='amount' placeholder='Enter Account Number' required />
